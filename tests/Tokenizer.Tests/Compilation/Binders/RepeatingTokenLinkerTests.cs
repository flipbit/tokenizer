...
public class RepeatingTokenLinkerTests
{
    ...
    {
        var nonRepeating = new Token("Name", "Preamble\n", new FileLocation());
        var repeating = new Token("Name", "Preamble", new FileLocation());
    ...
    {
        var nonRepeating = new Token("Other", "Preamble", new FileLocation());
        var repeating = new Token("Name", "Preamble", new FileLocation());
        repeating.IsRepeating = true;
        var template = new TemplateBuilder()
            .WithTokens(nonRepeating, repeating)
    ...
    {
        var nonRepeating = new Token("Name", "Preamble", new FileLocation());
        var repeating = new Token("Name", "Preamble", new FileLocation());
        repeating.IsRepeating = true;
